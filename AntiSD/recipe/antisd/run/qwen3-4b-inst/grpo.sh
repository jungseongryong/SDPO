#!/bin/bash
# v25-Q4-GRPO-4node: Qwen3-4B-Instruct-2507 GRPO baseline, 4 nodes, save every 10 steps.
set -e
...
EXP_NAME="v25-Q4-GRPO-4node-rollout16384-eval32768-mbs32-lr1e-6-${MODEL_NAME}"
